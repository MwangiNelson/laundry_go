...
import { DashboardNavbar } from "@/components/layouts/dashboard_nav";
import { DashboardSidebar } from "@/components/layouts/dashboard_sidebar";
  ...
  return (
    <DashboardUIProvider>
      <div className="bg-background text-foreground flex min-h-svh w-full font-poppins">
        <aside className="bg-primary text-muted-foreground flex h-svh sticky top-0">
          <DashboardSidebar />
        </aside>
