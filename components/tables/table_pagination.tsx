...
export function PageSizeSelector<TData>({ table }: TableProps<TData>) {
  return (
...
export function PageIndicator<TData>({ table }: TableProps<TData>) {
  return (
...
export function PageNavigator<TData>({ table }: TableProps<TData>) {
  return (
    <div className="flex items-center space-x-2">
      <Button
        variant="outline"
