...
import { OfficeCleaningOrderStatus } from "./office_cleaning_orders.data";
...
// ALL columns for Office Cleaning Orders table
export const officeCleaningOrdersColumns: ColumnDef<IOrder>[] = [
  {
    id: "customer",
    header: "Customer",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const statusMap: Record<string, OfficeCleaningOrderStatus> = {
        New: "new",
        Confirmed: "new",
        Ongoing: "ongoing",
        Completed: "complete",
